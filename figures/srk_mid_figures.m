...
srk_netgen_config = load(fullfile('..', 'results_netgen_attempt_srk_G_mid_longT', 'cube.mat'));
srk_lattice_config = load(fullfile('..', 'results_hypercube_attempt_srk_G_mid_longT', 'cube.mat'));

srk_netgen_results = load(fullfile('..', 'results_netgen_attempt_srk_G_mid_longT', 'out_gp.mat'));
srk_lattice_results = load(fullfile('..', 'results_hypercube_attempt_srk_G_mid_longT', 'out_gp.mat'));


dout = 'srk_mid_figures';
% 
% r = load(fullfile('..', 'results_netgen_attempt_srk_G_mid_longT', 'out_concat.mat'));
% for i = 1:1000
...
srk_lattice_a1 = load(fullfile('..', 'results_hypercube_attempt_srk_G_mid_longT', 'out_2.mat'));
...
saveas(gcf, fullfile(dout,'srk_lattice_traj_a1.epsc'));

figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
make_raster(srk_lattice_a1.net.sys.pk_t/60000, srk_lattice_a1.net.sys.pk_locs, srk_lattice_a1.net.sys.pops, 'order', idx);
axis tight
xlim([0,12.5]);
xticks([0,12.5]);
xticklabels([0,12.5]);
...
saveas(gcf, fullfile(dout,'srk_lattice_traj_a1_raster.epsc'));




srk_lattice_a2 = load(fullfile('..', 'results_hypercube_attempt_srk_G_mid_longT', 'out_6.mat'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
...
saveas(gcf, fullfile(dout,'srk_lattice_traj_a2.epsc'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
make_raster(srk_lattice_a2.net.sys.pk_t/60000, srk_lattice_a2.net.sys.pk_locs, srk_lattice_a2.net.sys.pops, 'order', idx);
axis tight
xlim([0,12.5]);
xticks([0,12.5]);
xticklabels([0,12.5]);
...
saveas(gcf, fullfile(dout,'srk_lattice_traj_a2_raster.epsc'));
srk_lattice_a3 = load(fullfile('..', 'results_hypercube_attempt_srk_G_mid_longT', 'out_3.mat'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
plot(srk_lattice_a3.net.sys.t_mean/60000, srk_lattice_a3.net.sys.y_pops(:,1), 'k', 'linewidth', 2);
plot(srk_lattice_a3.net.sys.t_mean/60000, srk_lattice_a3.net.sys.y_pops(:,2), 'b', 'linewidth', 2);
axis([0, 12.5, 0, 1]);
xticks([0,12.5]);
xticklabels([0,12.5]);
yticks([0,1]);
...
c = (1-max([round(srk_lattice_a3.assort,2),0]));
set(gca, 'color', [1,c,c]);
H = gca;
H.LineWidth = 2;
H.FontSize = 16;
...
saveas(gcf, fullfile(dout,'srk_lattice_traj_a1.epsc'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
make_raster(srk_lattice_a3.net.sys.pk_t/60000, srk_lattice_a3.net.sys.pk_locs, srk_lattice_a3.net.sys.pops, 'order', idx);
axis tight
xlim([0,12.5]);
xticks([0,12.5]);
xticklabels([0,12.5]);
...
set(gcf, 'color', [1,1,1]);
set(gcf, 'InvertHardCopy', 'off');
saveas(gcf, fullfile(dout,'srk_lattice_traj_a3_raster.png'));
saveas(gcf, fullfile(dout,'srk_lattice_traj_a3_raster.epsc'));
%% srk Lattice
...
scatter(srk_lattice_a3.assort, srk_lattice_a3.pvals(1), 200, 'ko', 'filled');
xticks([min(X(:)), max(X(:))]);
...
saveas(gcf, fullfile(dout,'srk_lattice_peaks.epsc'));
...
set(gcf, 'color', [1,1,1]);
set(gcf, 'InvertHardCopy', 'off');
saveas(gcf, fullfile(dout,'srk_lattice_ord.png'));
saveas(gcf, fullfile(dout,'srk_lattice_ord.epsc'));


%% Trajectories srk Netgen

srk_netgen_a1 = load(fullfile('..', 'results_netgen_attempt_srk_G_mid_longT', 'out_7.mat'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
...
saveas(gcf, fullfile(dout,'srk_netgen_traj_a1.epsc'));
...
srk_netgen_a2 = load(fullfile('..', 'results_netgen_attempt_srk_G_mid_longT', 'out_2.mat'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
...
saveas(gcf, fullfile(dout,'srk_netgen_traj_a2.epsc'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
...
srk_netgen_a3 = load(fullfile('..', 'results_netgen_attempt_srk_G_mid_longT', 'out_50.mat'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 300]);hold all;
...
scatter(srk_netgen_a3.assort, srk_netgen_a3.pvals(1), 200, 'ko', 'filled');
xticks([min(X(:)), max(X(:))]);
xticklabels([round(min(X(:)),2), round(max(X(:)),2)]);
yticks([min(Y(:)), max(Y(:))]);
yticklabels([round(min(Y(:)),2), round(max(Y(:)),2)]);
...
saveas(gcf, fullfile(dout,'srk_netgen_peaks.epsc'));
figure('Renderer', 'painters', 'Position', [10, 10, 500, 500]);hold all;
pcolor(X,Y,Z_ord);
